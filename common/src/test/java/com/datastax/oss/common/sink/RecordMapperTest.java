...
import static com.datastax.oss.common.sink.util.FunctionMapper.SUPPORTED_FUNCTIONS_IN_MAPPING;
import static com.datastax.oss.common.sink.util.SinkUtil.TIMESTAMP_VARNAME;
...
class RecordMapperTest {
  ...
  void should_return_statement_when_function_in_the_mapping(CqlIdentifier function) {
    ...
    Assertions.assertDoesNotThrow(() -> mapper.map(recordMetadata, record));
  }
